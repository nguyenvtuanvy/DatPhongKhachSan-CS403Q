...
namespace DoAnCS403Q.Web
{
    public class Global : System.Web.HttpApplication
    {
        ...
        {
            Tracing.Initialize();
            WebApplication.SetInstance(Session, new DoAnCS403QAspNetApplication());
            ...
            if (ConfigurationManager.ConnectionStrings["__ConnectionString"] != null)
            {
                WebApplication.Instance.ConnectionString = ConfigurationManager.ConnectionStrings["__ConnectionString"].ConnectionString;
            }
#if EASYTEST
